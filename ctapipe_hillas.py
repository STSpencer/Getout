...
def hillas_parameters(image):
    ...
    Each method gives the same result, but vary in effici
    image : array_like
    ...
    """
    unit = u.m
    pix_x = np.load('pixx.npy')
    pix_y = np.load('pixy.npy')
    ...
    return x,y,r,phi,intensity,length,width,psi,skewness,kurtosis
